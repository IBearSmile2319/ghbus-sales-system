...
public class WarningAlertBSNA extends javax.swing.JDialog {
    ...
    public WarningAlertBSNA(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int CambiarStado = blctd.cambiarestadoANoAbordo(Integer.parseInt(WarningAlertBSNA.id.getText()));
        if (CambiarStado != 0) {
            blctd.listarBoletos(buscar.getText());
            this.dispose();
            SuccessAlert sa = new SuccessAlert(new JFrame(), true);
            sa.titulo.setText("¡HECHO!");
            sa.msj.setText("SE HA CAMBIADO EL ESTADO DEL");
            sa.msj1.setText("REGISTRO DE BOLETOS");
            sa.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertBSNA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertBSNA dialog = new WarningAlertBSNA(new javax.swing.JFrame(), true);
