...
public class WarningAlertA1 extends javax.swing.JDialog {
    GananciasCTD gnctd=new GananciasCTD();
    Timer timer = null;
    TimerTask task;
    int i = 32;

    public WarningAlertA1(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = gnctd.eliminarTodo();
        if (elimina != 0) {
            gnctd.listarganancias("");
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertA1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertA1 dialog = new WarningAlertA1(new javax.swing.JFrame(), true);
