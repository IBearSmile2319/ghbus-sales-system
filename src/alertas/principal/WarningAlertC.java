...
public class WarningAlertC extends javax.swing.JDialog {
    ClientesCTD clctd=new ClientesCTD();
    Timer timer = null;
    TimerTask task;
    int i = 32;
    public WarningAlertC(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = clctd.eliminar(Integer.parseInt(WarningAlertC.id.getText()));
        if (elimina != 0) {
            clctd.listarCliente("");
            this.dispose();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertC dialog = new WarningAlertC(new javax.swing.JFrame(), true);
