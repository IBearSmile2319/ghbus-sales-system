...
public class WarningAlertBSA extends javax.swing.JDialog {
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int cambiarStado = blctd.cambiarestadoAabordo(Integer.parseInt(WarningAlertBSA.id.getText()));
        if (cambiarStado != 0) {
...
//            blctd.corteCaja();
            ...
            sa.msj1.setText("REGISTRO DE BOLETO");
            sa.setVisible(true);
        }
...
//                Opciones.corteCaja();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertBSA dialog = new WarningAlertBSA(new javax.swing.JFrame(), true);
